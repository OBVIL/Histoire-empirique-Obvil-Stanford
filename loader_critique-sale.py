...
os.environ["TMPDIR"] = "/var/www/media/tmp/" # alernative tmp for big sort

##########################
## System Configuration ##
##########################

database_root = '/var/www/media/critique-sale/'
...
template_dir = '/var/www/obvil/html/philologic/' + "www/"
...
metadata_xpaths = [ # metadata per type.  '.' is in this case the base element for the type, as specified in XPaths above.
    ...
    ("doc", './meta/date', 'date'),
    ("doc", './meta/creator', 'author'),
    ('doc', './meta/publisher', 'publisher'),
]

pseudo_empty_tags = ["milestone"]

## A list of tags to ignore
suppress_tags = ["teiHeader", "meta", ".//head", ".//note"]
